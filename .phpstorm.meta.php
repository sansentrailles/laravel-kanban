...
'view','update','delete','manageMembers',);
...
'session.same_site','session.partitioned','session.serialization','inertia.ssr.enabled','inertia.ssr.url',
...
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','boost.enabled',
...
'boost.browser_log_levels','mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','mcp.tool_search.max_tool_calls',
'mcp.tool_search.max_output_bytes','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','CACHE_STORE','QUEUE_CONNECTION',
'SESSION_DRIVER','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
